...
public class MessageOtherFragment extends Fragment {
    private Message message;
    private boolean isSenderEnabled;
    public MessageOtherFragment(Message message, boolean isSenderNameEnabled) {
        this.message = message;
        this.isSenderEnabled = isSenderNameEnabled;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_message_other, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        ((TextView)view.findViewById(R.id.messageSender)).setText(message.getSender().getName());
        ((TextView)view.findViewById(R.id.messageText)).setText(new String(message.getMessageTextContent()));
        ((TextView)view.findViewById(R.id.messageSender)).setVisibility(isSenderEnabled?View.VISIBLE:View.INVISIBLE);
